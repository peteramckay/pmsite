...
<script>\$(document).ready(function () { require('{{ jsNamespace }}').{{ jsClass }}.initElements(); });</script>", "@CoreHome\\_uiControl.twig", "/var/www/piwik/plugins/CoreHome/templates/_uiControl.twig");
    }
}
